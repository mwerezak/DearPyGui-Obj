...
@_dearpygui_wrapper('mvAppItemType::DebugWindow')
...
@_dearpygui_wrapper('mvAppItemType::MetricsWindow')
...
@_dearpygui_wrapper('mvAppItemType::StyleWindow')
...
@_dearpygui_wrapper('mvAppItemType::DocWindow')
...
@_dearpygui_wrapper('mvAppItemType::AboutWindow')
