...
class ItemWrapper:
    ...
    def add_keyword_parameter(cls, name: str, getconfig: Optional[Callable] = None) -> None:
        ...
        If the keyword parameter has already been added the previous **getconfig** will be overwritten.
    ...
    def __init__(self,
                 ...
                 **kwargs: Any):
        """
        All other keyword arguments will be passed to the :meth:`_setup_add_item` method used to
        add the item to DearPyGui. If a keyword has been added using the
        :meth:`add_keyword_parameter` method, it's value will be processed before being added to
